# 시원 (詩苑) - 한국 서정시 창작소 🌸 `Ver-9`
### TTS 슬래시 스킵 · 한국 시문학 심사평가위원 3인 평가 & 글다듬기(재구성) 엔진 · 멀티모달 사진 분석 · PDF 운율 학습 · 유튜브 BGM · 맞춤 성우 낭송 탑재

마음에 머무는 다섯 개의 단어를 직접 입력하거나 **업로드한 사진을 AI 멀티모달로 분석**하여, 한국 전통의 깊은 여운을 지닌 현대 서정시를 창작해 주는 웹 서비스입니다.  
**정보보안 지침을 철저히 준수**하여 Google Gemini API 키가 웹 클라이언트에 절대 노출되지 않도록 **보안 백엔드(Server-to-Server)** 구조로 설계되었으며, **한국 시문학 심사평가위원 3인의 심사평 및 글다듬기(재구성) 엔진**, **TTS 슬래시 발화 스킵**, **사진업로드및분석 메뉴탭 시스템**, **사진 표시창(Display Window)**, **분위기별 유튜브 배경음악 자동 재생**, **성우 맞춤형 낭송**, 그리고 **PDF 문헌 기반 시적 운율과 감정 융합 엔진**이 탑재되어 있습니다.
